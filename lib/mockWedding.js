...
export const weddingData = {
  ...
  dressCode: {
    ...
    illustrationAlt:
      'Three couples in traditional Yoruba attire in white and gold: white agbada, buba and iro worked in gold, with gold gele and fila.',
    /*
      Every one of these is sampled off the illustration above rather than
      picked to look right next to it, so a guest holding the drawing against
      a chip is comparing a colour to itself. They run as one range, white
      through champagne into gold, because a tailor needs somewhere to land
      between the two named colours as well as on them.

      These are the guests' colours and they are deliberately not the site's.
      The page stays blue and rose. Nothing here feeds the theme.
    */
    colors: [
