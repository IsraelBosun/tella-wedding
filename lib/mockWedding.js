...
export const weddingData = {
  ...
  story: {
    ...
    /*
      Sofiyyah's answer to the passage above, in her own words. It sits
      between his pull quote and the shared closing, so the section reads as
      him, then her, then the two of them together. Clear `reply` to drop it.
    */
    reply: {
      label: "In Sofiyyah's words",
      paragraphs: [
        'Sometimes you don’t know what you need until God pushes you into it.',
        'Knowing Abdulsalam was spontaneous, all thanks to Bisola. And ever since I knew him, he’s always been a calm and easy going person, one that matches and synchronizes with my person.',
        'Doing forever with him is Allah’s plan, which I wouldn’t have asked for in any other way.',
      ],
      pullQuote: 'Cheers to being your “SOFIA THE FIRST” forever ♾️ 🥂',
    },
  ...
  dressCode: {
    ...
    /*
      One drawing carrying both dress codes: the couple on the left in the
      bride's white and gold, the two on the right in the groom's wine and
      dusty rose. It replaces the white-and-gold-only drawing, which showed
      one side's colours while the text asked for two.
    */
    illustration: '/invitation/images/guest-attire-both-sides.webp',
    illustrationAlt:
      "Six guests in traditional Yoruba attire: agbada, buba and iro with gele and fila. The couple on the left wear the bride's white and gold, the two couples on the right the groom's wine and dusty rose.",
